...
class ETBI_Hubspot_Assets {
	...
	public static function enqueue_scripts( $hook ) {
		 ...
		 */
		do_action( 'etbi_hubspot_before_enqueue_scripts', $hook );
		 ...
		 */
		do_action( 'etbi_hubspot_after_enqueue_scripts', $hook );
	}
	...
	public static function _get_path_by_uri( $uri = '' ) {
		$base_url = trailingslashit( ETBI_HUBSPOT_URI );
		$path     = trailingslashit( ETBI_HUBSPOT_PATH );
